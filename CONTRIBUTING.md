# Contributing to terraform-azurerm-log-analytics-workspace

Thank you for your interest in contributing to the terraform-azurerm-log-analytics-workspace module! This document provides guidelines and instructions for contributing.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/terraform-azurerm-log-analytics-workspace.git
   cd terraform-azurerm-log-analytics-workspace
   ```
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/infoex/terraform-azurerm-log-analytics-workspace.git
   ```
...
Example:
```
feat: Add support for custom retention periods

Added support for configurable retention periods for Log Analytics
workspaces with validation to ensure values are within Azure's limits.
...
3. **Comments**: Use comments for complex logic
   ```hcl
   # Configure Log Analytics workspace with VM Insights
...
- Check existing [issues](https://github.com/infoex/terraform-azurerm-log-analytics-workspace/issues)
...
Thank you for contributing to terraform-azurerm-log-analytics-workspace!
